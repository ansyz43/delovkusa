...
const techCards: TechCard[] = [
  ...
  },
  {
    ...
    title: "Изысканные черешневые трюфели — МК",
    description:
      "Расширенный мастер-класс: ганаш на черешне, темперирование корпуса, декор. Подойдёт и новичкам, и для продажи через кондитерский магазин.",
    highlights: ["МК + техкарта", "Темперирование", "Идея на продажу"],
    price: 2000,
    priceLabel: "2 000 ₽",
  },
  {
    ...
    description:
      "Классический рецепт пластичного шоколада на белом шоколаде и глюкозе-сиропе. Идеален для лепки роз, листьев и фигурного декора — держит форму и не течёт.",
    highlights: ["Белый шоколад 25,9%", "Глюкоза-сироп 43%", "Для лепки цветов"],
    price: 2000,
    priceLabel: "2 000 ₽",
  },
  {
